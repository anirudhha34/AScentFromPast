...
.leftScene{
  position:absolute; inset:0; right:10%;
...
.knightImg{
  ...
  object-fit:cover;
  /* Framing so duck (right of fire) sits in the gap left of the parchment */
  object-position:48% 58%;
  display:block;
  filter:saturate(.7) brightness(.78) contrast(1.15) sepia(.08);
  /* Zoom out so more campsite (including the duck) fits in frame */
...
.rightWrap{
  ...
  padding:3.5vh 3vw 3.5vh calc(50% + 1vw);
